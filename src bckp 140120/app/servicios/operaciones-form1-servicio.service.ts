...
import { IPizzaFormInterface, IToppingItem, PizzaSizeEnum, PizzaToppingsEnum } from './evento-operaciones.interface';
...
export class OperacionesForm1ServicioService {
  ...
  constructor(
    private pizzaValidatorsService: OperacionesForm1ValidadorService,
